...
export default class Bird {
  ...
  jump() {
    ...
    TweenMax.to(this.LeftLegGroup.rotation, totalSpeed / 2, {
      x: "+=.5",
      ease: Back.easeOut
    });
    TweenMax.to(this.LeftLegGroup.rotation, totalSpeed / 2, {
    ...
    TweenMax.to(this.RightLegGroup.rotation, totalSpeed / 2, {
      x: "-=.5",
      ease: Back.easeOut
    });
    TweenMax.to(this.RightLegGroup.rotation, totalSpeed / 2, {
    ...
    TweenMax.to(this.legs.position, totalSpeed / 2, {
      y: "+=10",
      ease: Back.easeOut
    });
    TweenMax.to(this.legs.position, totalSpeed / 2, {
    ...
    TweenMax.to(this.wingLeftGroup.rotation, totalSpeed / 1.5, {
      y: "-=1",
      ease: Back.easeOut
    });
    TweenMax.to(this.wingLeftGroup.rotation, totalSpeed / 2, {
      y: "+=1",
      ease: Power4.easeIn,
      delay: totalSpeed / 1.5
    });

    TweenMax.to(this.wingRightGroup.rotation, totalSpeed / 1.5, {
      y: "-=1",
      ease: Back.easeOut
    });
    TweenMax.to(this.wingRightGroup.rotation, totalSpeed / 2, {
      y: "+=1",
      ease: Power4.easeIn,
      delay: totalSpeed / 1.5
    });
  ...
  chill() {
    ...
    TweenMax.to(this.LeftLegGroup.rotation, sp, { x: -1, ease: ease });
    TweenMax.to(this.RightLegGroup.rotation, sp, { x: -1, ease: ease });

    TweenMax.to(this.wingLeftGroup.rotation, sp, { y: -1, ease: ease });
    TweenMax.to(this.wingRightGroup.rotation, sp, { y: -1, ease: ease });
  ...
  stand() {
    ...
    TweenMax.to(this.leftIris.scale, sp, { y: 1, ease: ease });
    TweenMax.to(this.rightIris.scale, sp, { y: 1, ease: ease });
  ...
  blink() {
    ...
    TweenMax.to(this.leftIris.scale, sp / 2, {
      y: 1,
      ease: Power4.easeIn,
      delay: sp / 2
    });
    ...
    TweenMax.to(this.rightIris.scale, sp / 2, {
      y: 1,
      ease: Power4.easeIn,
      delay: sp / 2
    });
  ...
  loop() {
    ...
    this.bodyBird.material.color.setRGB(
      this.color.r,
      this.color.g,
      this.color.b
    );
