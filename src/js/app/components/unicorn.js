...
export default class Unicorn {
  ...
  talk() {
    ...
    this.tl.to(this.mouth.rotation, sp / 4, {
      x: 0,
      ease: Power4.easeIn,
      delay: sp / 4
    });
    ...
    this.tl.to(this.mouth.rotation, sp / 4, {
      ...
      ease: Power4.easeIn,
      delay: sp,
      onComplete: _this.checkDialogComplete.bind(_this)
    });
  ...
  chill() {
    ...
    TweenMax.to(this.eyeL.scale, sp, { y: 0.2, ease: ease });
    TweenMax.to(this.eyeR.scale, sp, { y: 0.2, ease: ease });
  }
  ...
  blink() {
    ...
    TweenMax.to(this.irisR.scale, sp / 4, {
      x: 1,
      ease: Power4.easeIn,
      delay: sp / 4
    });
    ...
    TweenMax.to(this.irisL.scale, sp / 4, {
      x: 1,
      ease: Power4.easeIn,
      delay: sp / 4
    });
