...
export default {
  ...
  chat: [
    ...
    [
      ...
      "but you were allergic to 3/4 cups cuz I loved Almond milk.",
      "(btw I hate it now..)",
    ...
    [
      ...
      "left me with all the people, awkward!",
      "but honestly what other ways would you do to make your first move?",
      "so let's just say it's the best one you could have done :)",
    ],
    [
    ...
    [
      ...
      "Don't wanna admit it but those are some of my favorite shots!",
      "So colorful, just like the wonderful Spring,",
      "being with you, everyday I live in the Dream Machine.",
    ],
    [
      "You never fail at surprising me,",
      "especially on the things that I want so much but I can't expect it to come true.",
    ...
    [
      ...
      "because everyday is perfect the way it is.",
    ],
    [
      "I loved that you tried so hard to hide it,",
      "again you were so good at suprising me.",
      "I think you were also more happy than myself when I told you the VISA news,",
      "so much love and joy",
      "you made me believe that it worthes all the hard work!",
    ],
    [
      "I never thought I'd able to ride a bike",
      "or I'd go to Governand Island and have a good time,",
      "or watch Nathan for you for a second time,",
      "or making beats with a bear paw,",
      "dear god you make everything possible!",
    ],
    [
