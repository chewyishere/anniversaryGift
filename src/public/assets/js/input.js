...
var guestHint = document.querySelector("#guestHint");
...
caret.style.fontSize = "2.2em";
caret.style.pointerEvents = "none";
caret.style.visibility = "hidden";
inputArea.append(caret);
...
simulate("2d", {
  ...
  action: function(e) {
    ...
    } else if (caret.textContent.toLowerCase() == "guest") {
      hint.classList.add("fadeOut");
      start.classList.remove("fadeOut");
      guest.classList.remove("fadeOut");
      guestHint.classList.add("fadeOut");
